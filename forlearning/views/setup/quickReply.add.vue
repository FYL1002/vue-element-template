<template>
  <el-dialog
    :title="isEdit?$t('settings.editQuickReply'):$t('settings.addQuickReply')"
    :visible="true"
  ...
  >
    <el-form ref="dialogForm" :model="dialogData" label-width="60px" :rules="rules">
      <el-form-item :label="'内容'" prop="content">
        ...
        <span class="name-item-des">请输入100字符以内</span>
      </el-form-item>
    </el-form>
    ...
    data() {
      return {
        ...
        rules: {
          content: [{
            required: true,
            message: '内容' + this.$t('noticeMsg.NotEmpty'),
            trigger: ['blur', 'change']
          }, {
            max: 100,
            message: '描述最大长度为100个字符',
            trigger: 'change'
          }]
        }
      };
